            ...
            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <form action="{{ route('admin.cart.store') }}" method="post">
                                            ...
                                            <input type="hidden" name="ssn" value="null">
                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            @if($cart_products->count() < 1) <div class="alert alert-danger">
                                No Product Added
                        </div>
                        @else
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('admin.cart.update', $product->rowId) }}" method="post">
                                        ...
                                        <td>
                                            @php
                                                $quantity = $products->where("id", $product->id)->first();
                                            @endphp
                                            <input type="number" name="qty" class="form-control" value="{{ $product->qty }}" max="{{ $quantity->code }}">
                                        </td>
                                        <td>
                                            <textarea name="ssn" class="form-control" rows="1">{{ ( $product->options[0] == 'null' ) ? '' : $product->options[0] }}</textarea>
                                        </td>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{ $product->id }}" action="{{ route('admin.cart.destroy', $product->rowId) }}" method="post" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
